...
public class TicTacToe {
    ...
    void initialise(char[][] board) {                       //To initialise.
    ...
    void declareWinner(int whoseTurn) {                 //For the Winner
    ...
    boolean rowCrossed(char[][] board) {                //FOr the row 
        for (int i = 0; i < SIDE; i++) {
    ...
    boolean colCrossed(char[][] board) {        //For the column
        for (int i = 0; i < SIDE; i++) {
    ...
    boolean diagonalCrossed(char[][] board) {               //For the diagonal section
    ...
    int minimax(char[][] board, int depth, boolean isAI) {      //This algo for finding the best move for the game 
        int score = 0;      
        int bestScore = 0;
        if (gameOver(board)) {
            if (isAI) {
    ...
    void playTicTacToe(int whoseTurn) {
        char[][] board = new char[SIDE][SIDE];              //All the interaction between the computer and the Human.
